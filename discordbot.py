...
help_embed_one.add_field(name="‣特殊チャンネル",value='━第３項',inline = True)
help_embed_one.add_field(name="‣ガチャ",value='━第４頁',inline = True)
help_embed_one.add_field(name="‣スロット",value='━第５頁',inline = True)
